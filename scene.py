...
# Create a scene with a text that is centered
class AnimatingMethods(Scene):
    def construct(self):
        ...
        self.play(grid.animate.shift(RIGHT))
...
class TextExample(Scene):
    def construct(self):
        ...
        difference = Text(
            ...
            t2c={"TexText": GREEN, "LaTeX": RED, "grammar": YELLOW, "TEXT": BLUE},
        )
...
class TexTransformExample(Scene):
    def construct(self):
        ...
        # the "\sqrt" part.
        new_line2 = MathTex("A^2 = (C + B)(C - B)", isolate=["A", *to_isolate])
